...
pub fn call_function(func: PyPointer<PyObject>, args: Vec<PyPointer<PyObject>>, arena: &mut PyArena) -> FuncReturnType {
    match *func.borrow() {
...
pub(crate) fn eval_internal_func(func: Rc<PyInternalFunction>, args: Vec<PyPointer<PyObject>>, arena: &mut PyArena) -> FuncReturnType {
    match (func.deref(), args.len()) {  //TODO figure out if I don't need to clone this
        ...
        (PyInternalFunction::InitFunc(func), n) => {
            ...
            Ok(PyPointer::new(PyObject::None))  // init always returns None
        }
...
pub(crate) fn eval_obj_init(pyclass: Rc<PyClass>, args: Vec<PyPointer<PyObject>>, arena: &mut PyArena) -> FuncReturnType {
...
pub(crate) fn init_internal_class(pyclass: Rc<PyClass>, args: Vec<PyPointer<PyObject>>, arena: &mut PyArena) -> FuncReturnType {
